...
function PaginaMonitoramento() {
  const cameras = [
    { id: 1, nome: "Entrada Principal", ativo: true, src: "/camera/cam-1.gif" },
    { id: 2, nome: "Estacionamento", ativo: true, src: "/camera/cam-2.gif" },
    { id: 3, nome: "Laboratório", ativo: true, src: "/camera/cam-3.gif" },
    { id: 4, nome: "Perímetro Norte", ativo: false, src: "/camera/cam-4.gif" },
  ]
          ...
          <GridCameras>
            {cameras.map((camera) => (
              <StyledCamera key={camera.id}>
                ...
                {camera.ativo ? (
                  <img src={camera.src} alt={camera.nome} className="feed-video" />
                ) : (
                  <img src="/camera/cam-4.gif" alt="Câmera Offline" className="feed-video" />
                )}
